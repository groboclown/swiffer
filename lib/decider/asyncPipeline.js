...
console.log(`[async ${self.name}] signal started`);
  ...
  this.onSignal(this._signalCompletedName, {
    getNextActions: function (eventlist, fromEventId) {
      ...
      var signalEvent = eventlist.getMostRecentEventByName(this._signalCompletedName);
  ...
  this.onSignal(this._signalFailedName, {
    getNextActions: function (eventlist, fromEventId) {
      ...
      var signalEvent = eventlist.getMostRecentEventByName(this._signalFailedName);
